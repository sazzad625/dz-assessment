...
@section('content')
    <div class="container">
        <h1 class="text-black-40 main-title">Department</h1>
        <div class="main-box">
                    ...
                    <ul class="list-inline m-0">
                      @hasPermission(App\Models\Permission::UPDATE_COURSE_CATEGORY_PERMISSION)
                        <li class="list-inline-item">
                            <a href="{{route('department.update', $department->id)}}" class="btn btn-primary btn-sm" type="button" data-toggle="tooltip" data-placement="top" title="Edit"><i class="cil-pencil"></i> Edit</a>
                        </li>
                      @endHasPermission
                      @hasPermission(App\Models\Permission::DELETE_COURSE_CATEGORY_PERMISSION)
                        <li class="list-inline-item">
                            <button class="btn btn-danger btn-sm btn-delete" type="button" data-toggle="tooltip" data-placement="top" title="Delete" data-id="{{$department->id}}"><i class="cil-trash"></i> Delete</button>
                        </li>
                      @endHasPermission
                    </ul>
                  </td>
