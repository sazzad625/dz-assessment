@extends('layouts.app')
@section('title', 'Update Course Categories')

@section('content')
    <div class="container">

        <h1 class="text-black-40 main-title">Update Course Categories</h1>
            ...
            <div class="row">
                ...
                <div class="form-group col-12 col-sm-6 col-md-6">
                    ...
                    <label class="c-switch c-switch-label c-switch-pill c-switch-primary">
                        <input class="c-switch-input" type="checkbox" id="active" value="true" name="active" {{old('active', $row->is_active) ? 'checked' : ''}}>
                ...
                <div class="form-group col-12 col-sm-6 col-md-6">
                    ...
                    <div class="dropzone-wrapper">
                        ...
                        <input type="file" class="file dropzone @error('image') is-invalid @enderror"
                           name="image" id="image" accept=".jpg, .jpeg, .png" name="img_logo">
                    </div>
                    @error('image')
                    <span class="help-block">{{$message}}</span>
                    @enderror
