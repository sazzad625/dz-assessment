...
use App\Http\Controllers\FileManager\ACLRepository;
use App\Http\Controllers\FileManager\ConfigFileRepository;
...
return [
     ...
     */
    'configRepository' => ConfigFileRepository::class,
     ...
     */
    'aclRepository' => ACLRepository::class,
    ...
    'aclRules' => [
//        null => [
//            ['disk' => 'oss', 'path' => 'secure/', 'access' => 2],
//        ],
//        1 => [
//            ['disk' => 'oss', 'path' => '/', 'access' => 1],
//            ['disk' => 'oss', 'path' => 'secure', 'access' => 1],
//            ['disk' => 'oss', 'path' => 'secure/*', 'access' => 2],
////            ['disk' => 'oss', 'path' => 'secure', 'access' => 2],
